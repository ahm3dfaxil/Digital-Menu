  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        {/* Mock Alert banner if Firebase is unconfigured */}
        {isMock && (
          <div className="mb-4 mx-4 sm:mx-0 p-3.5 bg-amber-50 dark:bg-amber-950/20 border border-amber-200 dark:border-amber-900/50 rounded-premium flex items-start gap-3">
            ...
            <div className="text-xs text-amber-800 dark:text-amber-300">
              <span className="font-bold">Evaluation Mode</span>: Firebase is not configured. Log in with email <strong>demo@menuflow.com</strong> and password <strong>password</strong> or click Google login.
            </div>
          </div>
        )}
